            ...
            <div className=''>
              <div className='container mx-auto px-[24px] sm:px-0'>
                <div className='bacxkgaAS mx-auto pt-[36px] sm:pt-[40px] md:pt-[48px] lg:pt-[64px] xl:pt-[96px] 2xl:pt-[120px] pb-[36px] sm:pb-[40px] md:pb-[48px] lg:pb-[64px] xl:pb-[96px] 2xl:pb-[120px] relative sm:gap-0 gap-12'>
                  <div ref={textRef} className='flex md:flex-row flex-col items-center justify-between gap-4'>
                  <div className="flex items-start justify-start flex-col">
                    ...
                    <h2  className='tradines text-[24px] sm:text-[32px] md:text-[36px] lg:text-[40px] xl:text-[48px] 2xl:text-[62px] !text-start mt-[10px] sm:mt-[11px] md:mt-[12px] '>
                     <span>Everything you need to trade </span><br className='lg:block hidden'/><span>with discipline.</span>  
                    </h2>
                  </div>
                    <p className='bitstartp text-[11px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[16px] 2xl:text-[18px] pb-[13px] sm:pb-[14px] md:pb-[15px] lg:pb-[16px] xl:pb-[20px] 2xl:pb-[24px] !text-start'>Built for traders who want clarity, structure, and<br className='lg:block hidden'/> real performance tracking not messy notes and <br className='lg:block hidden'/>random screenshots.</p>
                  </div>
                ...
                <div ref={cardsRef} className='grid items-start md:grid-cols-3 gap-[11px] sm:gap-[12px] md:gap-[13px] lg:gap-[14px] xl:gap-[15px] 2xl:gap-[16px]'> 
                  <div className='bordingrtexara h-fit relative pt-[8px] md:pt-[9px] lg:pt-[10px] 2xl:pt-[12px] pb-[14px] sm:pb-[15px] md:pb-[16px] lg:pb-[20px] xl:pb-[24px] 2xl:pb-[32px]  px-[8px] md:px-[9px] lg:px-[10px] 2xl:px-[12px] overflow-hidden'>
                    <LazyLoadImage className='w-full pb-[13px] sm:pb-[14px] md:pb-[15px] lg:pb-[16px] xl:pb-[20px] 2xl:pb-[24px]' src={imageone} alt='Loading...'/>
                    ...
                    <p className='throeconsper !text-[!908EAE] text-[10px] sm:text-[11px] md:text-[12px] lg:text-[13px] xl:text-[14px] mt-[6px] xl:mt-[7px] 2xl:mt-[8px] px-[12px] sm:px-[13px] md:px-[14px] lg:px-[15px] xl:px-[16px] 2xl:px-[20px]'>Capture entries, exits, position size, screenshots, and <br className='lg:block hidden'/>notes in a clean structured format.</p> 
                  </div>
                  {/* section 2 */}
                  <div className='bordingrtexara h-fit  pt-[8px] md:pt-[9px] lg:pt-[10px] 2xl:pt-[12px] pb-[14px] sm:pb-[15px] md:pb-[16px] lg:pb-[20px] xl:pb-[24px] 2xl:pb-[32px] px-[8px] md:px-[9px] lg:px-[10px] 2xl:px-[12px] overflow-hidden'>
                    <LazyLoadImage className='w-full pb-[13px] sm:pb-[14px] md:pb-[15px] lg:pb-[16px] xl:pb-[20px] 2xl:pb-[24px]' src={imagetwo} alt='Loading...'/>
                    ...
                    <p className='throeconsper text-[10px] sm:text-[11px] md:text-[12px] lg:text-[13px] xl:text-[14px] mt-[6px] xl:mt-[7px] 2xl:mt-[8px] px-[12px] sm:px-[13px] md:px-[14px] lg:px-[15px] xl:px-[16px] 2xl:px-[20px]'>Tag each trade by strategy and instantly see which <br className='lg:block hidden'/>setups are consistently profitable.
                    </p>
                  </div>
                  {/* section 3 */}
                  <div className='bordingrtexara h-fit relative pt-[8px] md:pt-[9px] lg:pt-[10px] 2xl:pt-[12px] pb-[14px] sm:pb-[15px] md:pb-[16px] lg:pb-[20px] xl:pb-[24px] 2xl:pb-[32px]  px-[8px] md:px-[9px] lg:px-[10px] 2xl:px-[12px] overflow-hidden'>
                    <LazyLoadImage className='w-full pb-[13px] sm:pb-[14px] md:pb-[15px] lg:pb-[16px] xl:pb-[20px] 2xl:pb-[24px]' src={imagethree} alt='Loading...'/>
                    ...
                    <p className='throeconsper text-[10px] sm:text-[11px] md:text-[12px] lg:text-[13px] xl:text-[14px] mt-[6px] xl:mt-[7px] 2xl:mt-[8px] px-[12px] sm:px-[13px] md:px-[14px] lg:px-[15px] xl:px-[16px] 2xl:px-[20px]'>Track win rate, profit factor, expectancy, drawdown, and <br className='lg:block hidden'/>risk-to-reward performance automatically.</p>
                  </div>
                </div>   
                <div ref={cardsRefs} className='grid items-center md:grid-cols-3 gap-[13px] sm:gap-[14px] md:gap-[15px] lg:gap-[16px] xl:gap-[20px] 2xl:gap-[24px]'> 
                  <div className='bordingrtexara h-fit relative pt-[8px] md:pt-[9px] lg:pt-[10px] 2xl:pt-[12px] pb-[14px] sm:pb-[15px] md:pb-[16px] lg:pb-[20px] xl:pb-[24px] 2xl:pb-[32px]  px-[8px] md:px-[9px] lg:px-[10px] 2xl:px-[12px] overflow-hidden'>
                    <LazyLoadImage className='w-full pb-[13px] sm:pb-[14px] md:pb-[15px] lg:pb-[16px] xl:pb-[20px] 2xl:pb-[24px]' src={imagefore} alt='Loading...'/>
                    ...
                    <p className='throeconsper text-[10px] sm:text-[11px] md:text-[12px] lg:text-[13px] xl:text-[14px] mt-[6px] xl:mt-[7px] 2xl:mt-[8px] px-[12px] sm:px-[13px] md:px-[14px] lg:px-[15px] xl:px-[16px] 2xl:px-[20px]'>Capture entries, exits, position size, screenshots, and <br className='lg:block hidden'/>notes in a clean structured format.</p> 
                  </div>
                  {/* section 2 */}
                  <div className='bordingrtexara  h-fit relative pt-[8px] md:pt-[9px] lg:pt-[10px] 2xl:pt-[12px] pb-[14px] sm:pb-[15px] md:pb-[16px] lg:pb-[20px] xl:pb-[24px] 2xl:pb-[32px]  px-[8px] md:px-[9px] lg:px-[10px] 2xl:px-[12px] overflow-hidden'>
                    <LazyLoadImage className='w-full pb-[13px] sm:pb-[14px] md:pb-[15px] lg:pb-[16px] xl:pb-[20px] 2xl:pb-[24px]' src={imagefive} alt='Loading...'/>
                  ...
                  {/* section 3 */}
                  <div className='bordingrtexara h-fit  relative pt-[8px] md:pt-[9px] lg:pt-[10px] 2xl:pt-[12px] pb-[14px] sm:pb-[15px] md:pb-[16px] lg:pb-[20px] xl:pb-[24px] 2xl:pb-[32px] px-[8px] md:px-[9px] lg:px-[10px] 2xl:px-[12px] overflow-hidden'>
                    <LazyLoadImage className='w-full pb-[13px] sm:pb-[14px] md:pb-[15px] lg:pb-[16px] xl:pb-[20px] 2xl:pb-[24px]' src={imagesix} alt='Loading...'/>
