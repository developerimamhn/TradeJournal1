...
// import image2 from '../assets/image fill.png';
// import image3 from '../assets/image.png';
// import image4 from '../assets/image120.png';
// import numbeingss from '../assets/image124.png';
// import image5 from '../assets/image1254.png';
// import lastone from '../assets/imagscase.png';
...
//                 <img ref={(el) => (logosRef.current[0] = el)} className='w-full brightness-75' src={image2} alt='Loading...'/>
//                 <img ref={(el) => (logosRef.current[1] = el)} className='w-full brightness-75' src={image3} alt='Loading...'/>
//                 <div ref={(el) => (logosRef.current[2] = el)} className='flex items-center justify-center'>
//                 <img className='w-1/2 brightness-75' src={image4} alt='Loading...'/>
//                 </div>
//                 <img ref={(el) => (logosRef.current[3] = el)} className='w-full brightness-75' src={numbeingss} alt='Loading...'/>
//                 <img ref={(el) => (logosRef.current[4] = el)} className='w-full brightness-75' src={image5} alt='Loading...'/>
//                 <div ref={(el) => (logosRef.current[5] = el)} className='flex items-center justify-center'>
//                 <img className='w-1/2 brightness-75' src={lastone} alt='Loading..'/>
//                 </div>
//               </div>
//            </div>  
//         </div>
